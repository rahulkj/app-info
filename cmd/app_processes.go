...
func getAppProcesses(app *DisplayApp, cli plugin.CliConnection) {
	...
	for _, appProcess := range appProcesses.Processes {
		if appProcess.AppProcessRelationship.AppRelationShip.AppRelationShipData.AppRelationShipGUID == app.AppGUID {
